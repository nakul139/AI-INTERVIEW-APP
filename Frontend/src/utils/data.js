...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get Interview questions and model answers based on your role, experience and specific focus areas - no more generic content.",
  },
  {
    id: "02",
    title: "Learn at your own pace",
    description:
      "Expand answers only when you're ready, dive deeper into any concepts instantly with AI-powered detailed explanations.",
  },
  {
    id: "03",
    title: "Capture Your Insights",
    description:
      "Add personal notes to any question and pin important ones to the top - making your learning journey more organize.",
  },
  {
    id: "04",
    title: "Understand the 'WHY' Behind Answers",
    description:
      "Beyound just answers - unlock detailed concept explanations genrated by AI, helping you truly master the subject.",
  },
  {
    id: "05",
    title: "Save, Organise, and Revisit",
    description:
      "Easily save your interview sets, organise them neatly in your dashboard, and pick up right where you left off.",
  },
];
