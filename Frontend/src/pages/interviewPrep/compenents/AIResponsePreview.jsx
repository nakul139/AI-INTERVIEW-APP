          ...
          components={{
            code({ node, className, children, ...props }) {
              ...
              return !isInline ? (
                ...
                <code
                  className="px-1 py-0.5 bg-gray-100 rounded text-[13px] font-mono text-gray-800"
                  {...props}
                >
                  {children}
                </code>
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-transparent border border-gray-200">
